"""Model configuration for the LangSmith evaluation demo."""
...
def load_env_files() -> None:
    """Load .env files from this folder and the langchain-example folder."""
...
def create_configured_model(
    ...
    """Create a chat model from this demo's environment variables."""
