"""Shared model configuration for MCP examples."""
...
def load_env_files() -> None:
    """Load .env from nearby LangChain example directories."""
...
def create_configured_model(
    ...
    """Create a chat model from env vars.

    Set LANGCHAIN_MODEL_PROVIDER=custom for an OpenAI-compatible provider.
    """
